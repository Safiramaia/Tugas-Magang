...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="container-fluid px-4 py-5">
            <h3 class="mt-4 mb-2">Data Kehadiran Siswa</h3>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="dashboard_admin.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Data Kehadiran Siswa</li>
            </ol>

            <a class="btn btn-primary mb-2" href="form_kehadiran.php">Tambah Kehadiran</a>
                    ...
                    <div class="table-responsive small">
                        <table class="table table-bordered" id="datatablesSimple">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach($db->tampil_kehadiran() as $x){
                                ?>
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $x['id'] ?></td>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="edit_kehadiran.php?id=<?php echo $x['id']; ?>&aksi=edit_kehadiran">Edit</a>
                                            <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus?')" href="proses_kehadiran.php?id=<?php echo $x['id']; ?>&aksi=hapus_kehadiran" >Hapus</a>
                                        </td>
