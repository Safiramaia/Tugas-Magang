    ...
    <div class="container-fluid px-2 py-5">
        <div class="row">
            ...
            <div class="col-md-9 ml-sm-auto">
                <h3 class="mt-4 mb-2">Tambah Data Pembayaran</h3>
            ...
            <main class="ml-sm-auto ml-md-auto ml-lg-0">
                <div class="container px-2 py-2">
                    ...
                    <form action="proses_pembayaran.php?aksi=tambah_pembayaran" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" name="status_pembayaran" value="Lunas" id="status_pembayaran">
                            <label class="form-check-label" for="status_pembayaran">Status</label>
                        </div>
